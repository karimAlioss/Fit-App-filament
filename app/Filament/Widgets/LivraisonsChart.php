...
class LivraisonsChart extends ChartWidget
{
    protected static ?string $heading = 'Livraisons';
    protected static ?int $sort = 3;

    protected function getData(): array
    {
        $statuses = Livraison::select('statu_id', DB::raw('COUNT(*) as count'))
            ->groupBy('statu_id')
            ->with('statu')
            ->get()
